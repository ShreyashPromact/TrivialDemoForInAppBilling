...
package com.project.example.inapp;
...
import com.project.example.inapp.util.IabHelper;
import com.project.example.inapp.util.IabResult;
import com.project.example.inapp.util.Inventory;
import com.project.example.inapp.util.Purchase;
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        String base64EncodedPublicKey = "";

        // Some sanity checks to see if the developer (that's you!) really followed the
        // instructions to run this sample (don't put these checks on your app!)
        /*if (base64EncodedPublicKey.contains("MIIB")) {
